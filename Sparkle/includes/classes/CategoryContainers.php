...
class CategoryContainers {
    ...
    public function showTVShowCategories() {
        ...
        $html = "<div class='previewCategories'>
                    <h1 style='color: #3ca5ff;'>TV Shows</h1> ";
    ...
    public function showMovieCategories() {
        ...
        $html = "<div class='previewCategories'>
                    <h1 style='color: #3ca5ff;'>Movies</h1> ";
    ...
    private function getCategoryHtml($sqlData, $title, $tvShows, $movies) {
        ...
        if($tvShows && $movies){
            $entities=EntityProvider::getEntities($this->con,$categoryId,25);
        }
        else if($tvShows){
        ...
        $entitiesHtml="";
        $previewProvider=new Preview($this->con,$this->username);
        foreach($entities as $entity){
            $entitiesHtml .=$previewProvider->createEntityPreviewSq($entity);
        }
