...
class EntityProvider {
    ...
    public static function getTVShowEntities($con, $categoryId, $limit) {
        ...
        $sql = "SELECT Distinct(entities.id) FROM entities INNER JOIN videos ON entities.id=videos.entityId and isMovie=0 ";
    ...
    public static function getMoviesEntities($con, $categoryId, $limit) {
        ...
        $sql = "SELECT Distinct(entities.id) FROM entities INNER JOIN videos ON entities.id=videos.entityId and isMovie=1 ";
